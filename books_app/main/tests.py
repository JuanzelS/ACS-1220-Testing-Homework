...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name='Ernest Hemingway').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, 'Ernest Hemingway')
    ...
    def test_unfavorite_book(self):
        ...
        # Verify book was added to favorites
        user = User.query.filter_by(username='me1').one()
        book = Book.query.get(1)
        self.assertIn(book, user.favorite_books)
